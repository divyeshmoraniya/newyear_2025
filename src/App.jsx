...
const App = () => {
  ...
  // Countdown to 2026 (or show celebration if past)
  useEffect(() => {
  ...
  // AI-generated wishes
  const wishes = [
    "May 2026 bring you endless joy, prosperity, and unforgettable moments! ✨",
    "Wishing you a year filled with love, laughter, and incredible adventures! 🎉",
    "Here's to new beginnings, amazing opportunities, and dreams coming true in 2026! 🌟",
    ...
    "May 2026 sparkle with moments of love, laughter, and goodwill! ✨"
  ];
  ...
  const downloadCard = () => {
    if (cardRef.current) {
      ...
      ctx.fillText('2026', canvas.width / 2, 250);
      ...
      canvas.toBlob((blob) => {
        ...
        a.href = url;
        a.download = `${userName}-NewYear-2026-Wish.png`;
        a.click();
